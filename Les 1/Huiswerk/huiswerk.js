...
function GPS (); {
	...
	this.start_interval = function (event) {
	...
	this.check_locations = function (event) {
	...
	this.calculate_distance = function (p1, p2) {
...
function Debugger () {
	this.geo_error_handler = function(code, message) {
